...
class App extends Component {
  ...
  //   fetch(`https://developer.nps.gov/api/v1/parks?limit=500&q=National%20Park&api_key=uwTVV65WHASDuGuVL9dZjoNDIO7OrW6q11S7rp7r&fields=images&parkCode=${id}`)
  //     .then(res => res.json())
              ...
              <div className="contentBox">
                <Switch>
                  ...
                  <Route path="/park-details/:id" render={(props) =>
                    <ParkDetails allParks={this.state.allParks}  id={props.match.params.id}/>
                    }/>
